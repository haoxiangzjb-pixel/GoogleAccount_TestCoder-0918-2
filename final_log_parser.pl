...
# Write the generated script content - using single quotes to avoid escaping issues
...
print $out_fh "my \$count = $error_count;\n";
...
print $out_fh "print \"Total errors found: \$count\\n\\n\";\n";
