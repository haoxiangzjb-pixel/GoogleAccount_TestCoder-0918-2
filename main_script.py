#!/usr/bin/env python3
"""
Main script that creates a PyMongo insertion script with a random filename.
"""
...
def create_pymongo_script_content():
    """Return the content for the PyMongo script as a string."""
...
def main():
    ...
    # Get the PyMongo script content
    ...
    print(f"PyMongo script has been created with the random filename: {random_filename}")
    print("The script is ready to run. Make sure MongoDB is running before executing it.")
